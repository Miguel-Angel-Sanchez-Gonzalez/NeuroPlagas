    ...
    if (value) {
        ...
        const filtered = greenWorkers.filter(green =>
            searchValue.every(val =>
                green.nombre.toLowerCase().includes(val)
            )
        );
    ...
    <div className="table-workgreen-admin">
      <div className="right-content-workgreen">
        <h1 className="h2green-workgreen">
          Trabajador {" "}
          <span className="name-greenworker">
            {" "}
            {nameWorker}
          </span>
        </h1>
        ...
        <div className="only-table-workgreen">
          ...
          {isLoading ? (
          <div className="loading-message">Espere un momento, se están cargando los invernaderos...</div>
            ...
            />
                    ...
                    <div className="no-workgreen-message">{noGreenworkerMessage || "Aún no se han asignado invernaderos para este trabajador."}</div>
                )}
                </div>
              </div>
          {/* {showDeleteWorker && (
